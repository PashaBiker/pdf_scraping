    ...
    for key, url in file_urls.items():
        ...
        try:
            with requests.Session() as session:
                ...
                span_elements = soup.find_all('span', class_='btn-container')

                for span in span_elements:
                    # Ищем тег <a> внутри span
                    a_tag = span.find('a', class_='custom-link')
                    if a_tag:
...
if __name__ == '__main__':
    ...
    excel_file = 'YOU Asset Management Limited.xlsm'
