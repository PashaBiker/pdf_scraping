...
def get_data(file):
    ...
    asset_labels = ['Structured and Global Bonds',
    ...
    with open(file, 'rb') as pdf_file:
        ...
        for line in lines[:]:
            ...
            for label in asset_labels[:]:  # создаем копию списка для безопасного удаления элементов во время итерации
                if label in line:
                    ...
                    if value:
                        ...
                        lines.remove(line)  # удаляем строку из списка
                        break  # выходим из внутреннего цикла, так как метка была найдена
