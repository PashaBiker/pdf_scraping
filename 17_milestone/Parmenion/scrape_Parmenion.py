    ...
    for key, url in file_urls.items():
        ...
        try:
            with requests.Session() as session:
                ...
                # Iterate over the download links and extract the URL and title
                for link in download_links:
                    url = link.find("a", class_="download-link__title")["href"]
                    title = link.find("a", class_="download-link__title").get_text(strip=True)
                    urls_dict[title] = url
