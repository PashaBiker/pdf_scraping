        ...
        try:
            with requests.Session() as session:
                ...
                headers = {
                    ...
                    'referer': 'https://www.quilter.com/documents/?filters=116472%2C116442%2C137171&page=2&Region=uk&Role=adv',
                ...
                params = {
                    'filters': '116472,116442,137171',
                    'page': '3',
                    'superCategory': 'documents',
                    'pageSize': '12',
                    'role': 'adv',
                    'region': 'uk',
                    'selectedFilters': '116472,116442,137171',
                    'lockedFilters': '',
                    'sortBy': 'a-z',
                }
                ...
                while True:
                    ...
                    response = requests.get('https://www.quilter.com/api/search/carmesitesearch/', params=params, headers=headers)
                    ...
                    for item in data["items"]:
                        title = item["title"]
                        content_url = "https://www.quilter.com" + item["contentUrl"]
...
if __name__ == '__main__':
    ...
    # excel_file = '18_milestone\Quilter\Quilter.xlsm'
    # excel_file = 'tests/quilter_new/Quilter.xlsm'
    excel_file = 'Quilter.xlsm'
